...
pub const LOS_RECORD_LR_CNT = 3;
// #endif

// #define OS_MEM_ALIGN_SIZE   (sizeof(UINTPTR))
pub const OS_MEM_ALIGN_SIZE = (@sizeOf(t.UINTPTR));
...
pub const MALLOC_HOOK = *const fn () void;
...
pub extern var g_MALLOC_HOOK: ?MALLOC_HOOK;
...
pub extern var m_aucSysMem0: ?*t.UINT8;
...
pub extern var m_aucSysMem1: ?*t.UINT8;
...
pub extern var g_excInteractMemSize: t.UINTPTR;
// #endif
...
pub extern fn LOS_MemMalloc(pool: *t.VOID, size: t.UINT32, moduleId: t.UINT32) *t.VOID;
// /**
//  * @ingroup los_memory
...
pub extern fn LOS_MemMallocAlign(pool: *t.VOID, size: t.UINT32, boundary: t.UINT32, moduleId: t.UINT32) *t.VOID;
...
pub extern fn LOS_MemMfree(pool: *t.VOID, ptr: *t.VOID, moduleId: t.UINT32) t.UINT32;
...
pub extern fn LOS_MemMrealloc(pool: *t.VOID, ptr: *t.VOID, size: t.UINT32, moduleId: t.UINT32) *t.VOID;
...
pub extern fn LOS_MemMusedGet(moduleId: t.UINT32) t.UINT32;
// #endif
...
pub extern fn LOS_MemDeInit(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemPoolList() t.UINT32;
// #endif
...
//  */
pub const LOS_MEM_POOL_STATUS = struct {
    uwTotalUsedSize: t.UINT32 = 0,
    uwTotalFreeSize: t.UINT32 = 0,
    uwMaxFreeNodeSize: t.UINT32 = 0,
    uwUsedNodeNum: t.UINT32 = 0,
    uwFreeNodeNum: t.UINT32 = 0,
    LOSCFG_MEM_TASK_STAT: ?struct {
        uwUsageWaterLine: t.UINT32 = 0, //*< this structure member is defined only when LOSCFG_MEM_TASK_STAT is defined. */
    } = if (defines.LOS_MEM_POOL_STATUS) .{} else null,
};
...
pub extern fn LOS_MemInit(pool: *t.VOID, size: t.UINT32) t.UINT32;
...
pub extern fn LOS_MemAlloc(pool: *t.VOID, size: t.UINT32) *t.VOID;
...
pub extern fn LOS_MemFree(pool: *t.VOID, ptr: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemRealloc(pool: *t.VOID, ptr: *t.VOID, size: t.UINT32) *t.VOID;
...
pub extern fn LOS_MemAllocAlign(pool: *t.VOID, size: t.UINT32, boundary: t.UINT32) *t.VOID;
...
pub extern fn LOS_MemPoolSizeGet(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemTotalUsedGet(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemFreeBlksGet(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemUsedBlksGet(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemTaskIdGet(ptr: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemLastUsedGet(pool: *t.VOID) t.UINTPTR;
// /**
//  * @ingroup los_memory
...
pub extern fn LOS_MemInfoGet(pool: *t.VOID, poolStatus: *LOS_MEM_POOL_STATUS) t.UINT32;
// /**
//  * @ingroup los_memory
...
pub extern fn LOS_MemFreeNodeShow(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemIntegrityCheck(pool: *t.VOID) t.UINT32;
...
pub extern fn LOS_MemCheckLevelSet(checkLevel: t.UINT8) t.UINT32;
...
pub extern fn LOS_MemCheckLevelGet() t.UINT8;
// #endif
...
pub const LOS_MEM_CHECK_LEVEL_LOW = 0;
...
pub const LOS_MEM_CHECK_LEVEL_HIGH = 1;
// /**
//  * @ingroup los_memory
//  * Define a mem size check intensity
//  *
...
pub const LOS_MEM_CHECK_LEVEL_DISABLE = 0xff;
// /**
//  * @ingroup los_memory
//  * Define a mem size check intensity.
//  *
...
pub const LOS_MEM_CHECK_LEVEL_DEFAULT = LOS_MEM_CHECK_LEVEL_DISABLE;
// /**
//  * @ingroup los_memory
...
pub const LOS_ERRNO_MEMCHECK_PARA_NULL = _error.LOS_ERRNO_OS_ERROR(_error.LOS_MOUDLE_ID.LOS_MOD_MEM, 0x1);
