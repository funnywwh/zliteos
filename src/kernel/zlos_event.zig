...
//  */
pub const EVENT_CB_S = struct {
    uwEventID: t.UINT32 = 0, //**< Event mask in the event control block,
    //indicating the event that has been logically processed. */
    stEventList: list.LOS_DL_LIST = .{}, //**< Event control block linked list */
};
pub const PEVENT_CB_S = *EVENT_CB_S;
