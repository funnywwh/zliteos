...
const zlos_error = @import("../../../kernel/zlos_error.zig");
const trace = @import("../../../kernel/include/zlos_trace.zig");
// #ifdef LOSCFG_KERNEL_TRACE
// LITE_OS_SEC_BSS STATIC
pub var g_traceEventCount: t.UINT32 = 0;
// LITE_OS_SEC_BSS STATIC volatile enum TraceState g_traceState = TRACE_UNINIT;
pub var g_traceState: trace.TraceState = .TRACE_UNINIT;
// LITE_OS_SEC_DATA_INIT STATIC volatile BOOL g_enableTrace = FALSE;
pub var g_enableTrace: t.BOOL = t.FALSE;
// LITE_OS_SEC_BSS STATIC UINT32 g_traceMask = TRACE_DEFAULT_MASK;
pub var g_traceMask: t.UINT32 = trace.TraceState.TRACE_DEFAULT_MASK;
